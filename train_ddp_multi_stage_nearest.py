...
def train(args, loader, loader2, loader3, generator, discriminator, g_optim, d_optim, g_ema, g_ema_temp, g_ema_temp2, device, fid_dataset, fid_dataset2, fid_dataset3, n_scales, writer, path):
    ...
    ################################################## phase1 training
    g_module.re_init_phase(1, 'nearest')
    g_ema_temp.re_init_phase(1, 'nearest')
    ...
    ################################################## phase2 training
    g_module.re_init_phase(2, 'nearest')
    g_ema_temp2.re_init_phase(2, 'nearest')
    ...
    ################################################## phase2 training
    g_module.re_init_phase(3, 'nearest')
    g_ema.re_init_phase(3, 'nearest')
    for idx in pbar:
